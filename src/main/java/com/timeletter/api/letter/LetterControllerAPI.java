...
public class LetterControllerAPI {
        ...
        @Operation(summary = "urlSlug 편지 상세 조회", description = "회원이 보유한 편지 상세 내용을 조회합니다.")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "OK !!"),
                        @ApiResponse(responseCode = "400", description = "BAD REQUEST !!"),
                        @ApiResponse(responseCode = "403", description = "FORBIDDEN !!"),
        ...
        public ResponseEntity<?> findLetterByUrlSlug(@PathVariable("urlSlug") String urlSlug) {
                return letterService.processFindLetterByUrlSlug(urlSlug);
        }
        ...
        public ResponseEntity<?> updateLetterReceiver(@RequestBody LetterDTO dto) {
                ...
                // return
                // letterService.processUpdateLetterReceiver(dto.getId(),dto.getReceivedPhoneNumber());
        }
